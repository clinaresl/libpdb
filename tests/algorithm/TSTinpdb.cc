...
// check that MAX inPDBs generated for the unit variant of the N-Pancake are
// correctly retrieved
// ----------------------------------------------------------------------------
...
// check that MAX inPDBs generated for the heavy-cost variant of the N-Pancake
// are correctly retrieved
// ----------------------------------------------------------------------------
TEST_F (InPDBFixture, NPancakeHeavyCostMaxRead) {
